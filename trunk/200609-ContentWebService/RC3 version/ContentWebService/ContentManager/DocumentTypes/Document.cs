...
//============================================================== 
  public class Document
  {
    ...
    //============================================================
    ///<summary>
    ///    The Document constructor is empty.
    ///</summary>
    public Document()
    {
    }
    ...
    ///<summary>
    ///    Document Author meta data field (sample meta data)
    ///</summary>
    public string Author;
    ///<summary>
    ///    Document Title meta data field (sample meta data)
    ///</summary>
    public string Title;
    ///<summary>
    ///    Document Abstract meta data field (sample meta data)
    ///</summary>
    public string Abstract;
    ///<summary>
    ///    Document Categories meta data field (sample meta data)
    ///</summary>
    public string[] Categories;

    ///<summary>
    /// Document file name (including application extension).
    /// Used to save the binary content in the target Content Directory
    ///</summary>
    public string FileName;

    ///<summary>
    ///    Document Base64 encoded binary content
    ///</summary>
    public string Data;
